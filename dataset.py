...
def return_dataset(cfg):
    if cfg.dataset_name=='volleyball':
        ...
        with open('/home/shelter/shelterX/data/collective/tracks_normalized.pkl', 'rb') as f:
        ...
        training_set=CollectiveDataset(train_anns,tracks,train_frames,
                                      cfg.data_path,cfg.image_size,cfg.out_size,
                                      num_frames = cfg.num_frames, is_training=True,is_finetune=(cfg.training_stage==1))

        validation_set=CollectiveDataset(test_anns,tracks,test_frames,
                                      cfg.data_path,cfg.image_size,cfg.out_size,
